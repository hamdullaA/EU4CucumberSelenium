...
public class NavigationMenuStepDefs {
    ...
    public void the_user_navigates_to_the_Fleet_Vehicles() {
        System.out.println("the user navigates to the Fleet,Vehicles");
    }

    @Then("the title should be Vehicles")
    public void the_title_shoule_be_Vehicles() {
